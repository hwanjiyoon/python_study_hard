...
bmi_round = round(bmi, 2)
if bmi <= 18.5:
    print(f"당신의 bmi 지수는 {bmi_round}이고,저체중입니다.")
elif bmi <= 23:
    print(f"당신의 bmi 지수는 {bmi_round}이고,정상입니다.")
elif bmi <= 25:
    print(f"당신의 bmi 지수는 {bmi_round}이고,과체중입니다.")
else:
    print(f"당신의 bmi 지수는 {bmi_round}이고,비만입니다.")
